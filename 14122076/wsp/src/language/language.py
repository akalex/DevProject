...
class Language:
    """
    This class configures the internationalization of WSP, retrieving the
    ...
    def configure(self, lang=None):
        """
        Configures the funcion "_" for translating the texts of WSP, this method
        ...
        if lang not in self.AVAILABLE_LANGS:  #if lang is not between the lang translated, english by default
            lang = 'en'
        lan = gettext.translation('wsp', self.LANG_PATH, languages=[lang], codeset="UTF-8")

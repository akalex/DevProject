...
'''
stats.py -  vulndb.db class for statistics

'''
class vulnDBStats(object):
    ...
    def stats(self):
        ...
        print"---------------------------------------------------------------"
        print "vulnDB.db Statistics"
        print "Distinct values of CVEs and associated third party references"
 
        self.cur.execute("SELECT * from stat_vulndb_kpi; ") 
    ...
    def latest_cve(self):
        ...
        print"---------------------------------------------------------------"
        print "vulnDB.db Statistics : Latest added CVEs"

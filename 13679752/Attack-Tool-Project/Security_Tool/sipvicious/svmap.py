...
# Class DrinkOrSip : inherits from the base class object. New-style Classes
# Mandatory and optional args can be identified with the __init__ method
class DrinkOrSip(object):
    #DrinkOrSip Comment : constructor - takes one parameter. This is arguments received from main.py wrapper
...
# Class SVMAP : inherits from the base class object. New-style Classes
# Mandatory and optional args can be identified with the __init__ method
class SVMAP(object):

    #SVMAP Comment :  beware if you change anything below - execution starts here
    def main(self):
        ...
        if options.autogetip:
            ...
            # Close socket.
            tmpsocket.close()
        #We call an instance of the class DrinkOrSip defined above

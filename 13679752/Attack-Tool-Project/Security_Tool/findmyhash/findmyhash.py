...
# This class with describe all "global" variables that we will use.
# Not to declare variables separately in each class, we will describe them only once in this class and then will
# inherit all subsequent classes.
class GLOBAL_VARS(object):
    ########################################################################################################
    ### CONSTANTS
    ########################################################################################################

    # Describe all known algorithm
    MD4 = "md4"
    MD5 = "md5"
    SHA1 = "sha1"
    SHA224 = "sha224"
    ...
    # Create a list of USER_AGENTS to make a request.
    USER_AGENTS = [
...
# Class SCHWETT : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class SCHWETT(GLOBAL_VARS):
    ...
    # def __init__(self):
    #     self.name = "schwett"
    #     self.url = "http://schwett.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    #  ... etc ...
    name = "schwett"
    url = "http://schwett.com"
    supported_algorithm = [GLOBAL_VARS.MD5]
    ...
    def crack(self, hashvalue, alg):
        ...
        # Make the request
        response = FINDMYHASH().do_HTTP_request(url)
...
# Class NETMD5CRACK : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class NETMD5CRACK(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "netmd5crack"
    #     self.url = "http://www.netmd5crack.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    #  ... etc ...
    name = "netmd5crack"
...
# Class MD5_CRACKER : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5_CRACKER(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "md5-cracker"
    #     self.url = "http://www.md5-cracker.tk"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "md5-cracker"
...
# Class BENRAMSEY : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class BENRAMSEY(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "benramsey"
    #     self.url = "http://tools.benramsey.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "benramsey"
...
# Class GROMWEB : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class GROMWEB(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class HASHCRACKING : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class HASHCRACKING(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "hashcracking"
    #     self.url = "http://md5.hashcracking.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "hashcracking"
...
# Class VICTOROV : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class VICTOROV(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class THEKAINE : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class THEKAINE(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class TMTO : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class TMTO(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class MD5_DB : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5_DB(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class MY_ADDR : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MY_ADDR(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    def crack(self, hashvalue, alg):
        ...
        # Make the request
        response = FINDMYHASH().do_HTTP_request(url, params)
...
# Class MD5PASS: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5PASS(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class MD5DECRYPTION: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5DECRYPTION(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "md5decryption"
    #     self.url = "http://md5decryption.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "md5decryption"
...
# Class MD5CRACK: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5CRACK(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class MD5ONLINE: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5ONLINE(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class MD5_DECRYPTER: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5_DECRYPTER(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "md5-decrypter"
    #     self.url = "http://md5-decrypter.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "md5-decrypter"
...
# Class AUTHSECUMD5: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class AUTHSECUMD5(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "authsecu"
    #     self.url = "http://www.authsecu.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "authsecu"
...
# Class HASHCRACK: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class HASHCRACK(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "hashcrack"
    #     self.url = "http://hashcrack.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1, GLOBAL_VARS.MYSQL, ...]
    name = "hashcrack"
    url = "http://hashcrack.com"
    supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1, GLOBAL_VARS.MYSQL, GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
    ...
    def crack(self, hashvalue, alg):
        ...
        hash2 = None
        if alg in [GLOBAL_VARS.LM, GLOBAL_VARS.NTLM] and ':' in hashvalue:
            if alg == GLOBAL_VARS.LM:
        ...
        if alg == GLOBAL_VARS.MYSQL and hash2[0] == '*':
            hash2 = hash2[1:]
...
# Class OPHCRACK: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class OPHCRACK(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "ophcrack"
    #     self.url = "http://www.objectif-securite.ch"
    #     self.supported_algorithm = [GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
    name = "ophcrack"
    url = "http://www.objectif-securite.ch"
    supported_algorithm = [GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
...
# Class C0LLISION: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class C0LLISION(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "c0llision"
    #     self.url = "http://www.c0llision.net"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
    name = "c0llision"
    url = "http://www.c0llision.net"
    supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
    ...
    def crack(self, hashvalue, alg):
        ...
        # Check if hashvalue has the character ':'
        if alg in [GLOBAL_VARS.LM, GLOBAL_VARS.NTLM] and ':' not in hashvalue:
            return None

        # Look for "hash[_csrf_token]" parameter
        response = FINDMYHASH().do_HTTP_request("http://www.c0llision.net/webcrack.php")
        html = None
        if response:
            html = response.read()
        else:
        ...
        match = None
        if alg in [GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]:
            html = html.replace('\n', '')
            result = ""
...
# Class REDNOIZE: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class REDNOIZE(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = ""rednoize"
    #     self.url = "http://md5.rednoize.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1]
    name = "rednoize"
    url = "http://md5.rednoize.com"
    supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1]
...
# Class CMD5: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class CMD5(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "cmd5"
    #     self.url = "http://www.cmd5.org"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.NTLM]
    name = "cmd5"
    url = "http://www.cmd5.org"
    supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.NTLM]
    ...
    def crack(self, hashvalue, alg):
        ...
        response = FINDMYHASH().do_HTTP_request("http://www.cmd5.org/")
        html = None
        if response:
            html = response.read()
        else:
        ...
        # Make the request
        response = FINDMYHASH().do_HTTP_request(url, params, header)
...
# Class AUTHSECUCISCO7: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class AUTHSECUCISCO7(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    #     self.name = "authsecu"
    #     self.url = "http://www.authsecu.com"
    #     self.supported_algorithm = [GLOBAL_VARS.CISCO7]
    name = "authsecu"
    url = "http://www.authsecu.com"
    supported_algorithm = [GLOBAL_VARS.CISCO7]
...
# Class CACIN: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class CACIN(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class IBEAST: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class IBEAST(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class PASSWORD_DECRYPT: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class PASSWORD_DECRYPT(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "password-decrypt"
    #     self.url = "http://password-decrypt.com"
    #     self.supported_algorithm = [GLOBAL_VARS.CISCO7, GLOBAL_VARS.JUNIPER]
    name = "password-decrypt"
    url = "http://password-decrypt.com"
    supported_algorithm = [GLOBAL_VARS.CISCO7, GLOBAL_VARS.JUNIPER]
...
# Class BIGTRAPEZE: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class BIGTRAPEZE(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "bigtrapeze"
    #     self.url = "http://www.bigtrapeze.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "bigtrapeze"
    ...
    def crack(self, hashvalue, alg):
        ...
        headers = {"User-Agent": GLOBAL_VARS.USER_AGENTS[randint(0, len(GLOBAL_VARS.USER_AGENTS)) - 1]}

        # Make the request
        response = FINDMYHASH().do_HTTP_request(url, params, headers)
        ...
        match = search(
            r'Congratulations!<li>The hash <strong>[^<]*</strong> has been deciphered to: <strong>[^<]*</strong></li>',
            html)
...
# Class HASHCHECKER: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class HASHCHECKER(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "hashchecker"
    #     self.url = "http://www.hashchecker.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "hashchecker"
...
# Class MD5HASHCRACKER: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5HASHCRACKER(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "md5hashcracker"
    #     self.url = "http://md5hashcracker.appspot.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "md5hashcracker"
...
# Class PASSCRACKING: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class PASSCRACKING(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "passcracking"
    #     self.url = "http://passcracking.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "passcracking"
...
# Class SKCHECK: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class ASKCHECK(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "askcheck"
    #     self.url = "http://askcheck.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD4, GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1, GLOBAL_VARS.SHA256]
    name = "askcheck"
    url = "http://askcheck.com"
    supported_algorithm = [GLOBAL_VARS.MD4, GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1, GLOBAL_VARS.SHA256]
...
# Class FOX21: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class FOX21(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "fox21"
    #     self.url = "http://cracker.fox21.at"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
    name = "fox21"
...
# Class NICENAMECREW: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class NICENAMECREW(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "nicenamecrew"
    #     self.url = "http://crackfoo.nicenamecrew.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1, GLOBAL_VARS.LM]
    name = "nicenamecrew"
    url = "http://crackfoo.nicenamecrew.com"
    supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1, GLOBAL_VARS.LM]
    ...
    def crack(self, hashvalue, alg):
        ...
        hash2 = None
        if alg in [GLOBAL_VARS.LM] and ':' in hashvalue:
            hash2 = hashvalue.split(':')[0]
        else:
            hash2 = hashvalue
...
# Class JOOMLAAA: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class JOOMLAAA(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class MD5_LOOKUP: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5_LOOKUP(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "md5-lookup"
    #     self.url = "http://md5-lookup.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "md5-lookup"
...
# Class SHA1_LOOKUP: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class SHA1_LOOKUP(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "sha1-lookup"
    #     self.url = "http://sha1-lookup.com"
    #     self.supported_algorithm = [GLOBAL_VARS.SHA1]
    name = "sha1-lookup"
    url = "http://sha1-lookup.com"
    supported_algorithm = [GLOBAL_VARS.SHA1]
...
# Class SHA256_LOOKUP: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class SHA256_LOOKUP(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "sha256-lookup"
    #     self.url = "http://sha-256.sha1-lookup.com"
    #     self.supported_algorithm = [GLOBAL_VARS.SHA256]
    name = "sha256-lookup"
    url = "http://sha-256.sha1-lookup.com"
    supported_algorithm = [GLOBAL_VARS.SHA256]
...
# Class RIPEMD160_LOOKUP: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class RIPEMD160_LOOKUP(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "ripemd-lookup"
    #     self.url = "http://www.ripemd-lookup.com"
    #     self.supported_algorithm = [GLOBAL_VARS.RIPEMD]
    name = "ripemd-lookup"
    url = "http://www.ripemd-lookup.com"
    supported_algorithm = [GLOBAL_VARS.RIPEMD]
...
# Class MD5_COM_CN: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5_COM_CN(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "md5.com.cn"
    #     self.url = "http://md5.com.cn"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "md5.com.cn"
    url = "http://md5.com.cn"
    supported_algorithm = [GLOBAL_VARS.MD5]
...
# Class DIGITALSUN: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class DIGITALSUN(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "digitalsun.pl"
    #     self.url = "http://md5.digitalsun.pl"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "digitalsun.pl"
...
# Class DRASEN: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class DRASEN(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "drasen.net"
    #     self.url = "http://md5.drasen.net"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "drasen.net"
...
# Class MYINFOSEC: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MYINFOSEC(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "myinfosec"
    #     self.url = http://md5.myinfosec.net"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "myinfosec"
...
# Class MD5_NET: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5_NET(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class NOISETTE: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class NOISETTE(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "noisette.ch"
    #     self.url = "http://md5.noisette.ch"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5]
    name = "noisette.ch"
...
# Class MD5HOOD: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class MD5HOOD(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class STRINGFUNCTION: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class STRINGFUNCTION(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "stringfunction"
    #     self.url = "http://www.stringfunction.com"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1]
    name = "stringfunction"
    ...
    def crack(self, hashvalue, alg):
        ...
        match = search(
            r'<textarea class="textarea-input-tool-b" rows="10" cols="50" name="result"[^>]*>[^<]+</textarea>', html)
...
# Class ANADREL: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class XANADREL(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "99k.org"
    #     self.url = "http://xanadrel.99k.org"
    #     self.supported_algorithm = [GLOBAL_VARS.MD4, GLOBAL_VARS.MD5]
    name = "99k.org"
    url = "http://xanadrel.99k.org"
    supported_algorithm = [GLOBAL_VARS.MD4, GLOBAL_VARS.MD5]
...
# Class SANSL: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class SANS(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    def crack(self, hashvalue, alg):
        ...
        # Build the parameters
        response = FINDMYHASH().do_HTTP_request(url, httpheaders=headers)
        html = None
        if response:
            html = response.read()
        else:
...
# Class BOKEHMAN: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class BOKEHMAN(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
...
# Class GOOG_LI: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class GOOG_LI(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # def __init__(self):
    #     self.name = "goog.li"
    #     self.url = "http://goog.li"
    #     self.supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.MYSQL, GLOBAL_VARS.SHA1, ...]
    name = "goog.li"
    url = "http://goog.li"
    supported_algorithm = [GLOBAL_VARS.MD5, GLOBAL_VARS.MYSQL, GLOBAL_VARS.SHA1,
                           GLOBAL_VARS.SHA224, GLOBAL_VARS.SHA384, GLOBAL_VARS.SHA256, GLOBAL_VARS.SHA512,
                           GLOBAL_VARS.RIPEMD, GLOBAL_VARS.NTLM, GLOBAL_VARS.GOST, GLOBAL_VARS.WHIRLPOOL,
                           GLOBAL_VARS.LDAP_MD5, GLOBAL_VARS.LDAP_SHA1]
    ...
    def crack(self, hashvalue, alg):
        ...
        hash2 = None
        if alg in [GLOBAL_VARS.NTLM] and ':' in hashvalue:
            hash2 = hashvalue.split(':')[1]
        else:
            hash2 = hashvalue
...
# Class WHREPORITORY: inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class WHREPORITORY(GLOBAL_VARS):
    # Definitions of member class variables
    # These variables, will be called as self.xxx in the class methods
    # It's a coding error to declare these variables here
    # Normally, we declare an __init__ function (which is the class
    ...
    # A better way to write this code would be :
    # def __init__(self):
    #     self.name = "Windows Hashes Repository"
    #     self.url = "http://nediam.com.mx"
    #     self.supported_algorithm = [GLOBAL_VARS.LM, GLOBAL_VARS.NTLM]
...
# Class FINDMYHASH : inherits from the class GLOBAL_VARS.
# Mandatory and optional args can be identified with the __init__ method
class FINDMYHASH(GLOBAL_VARS):
    ...
    def configureCookieProcessor (self, cookiefile='/tmp/searchmyhash.cookie'):
        ...
        # library’s Set-Cookie3 file format. This is convenient if you want to store cookies in a human-readable file.
        ...
        if cookieHandler is not None:
            ...
            # instances of BaseHandler, or subclasses of BaseHandler (in which case it must be possible to call the constructor without any parameters).
            opener = urllib2.build_opener ( urllib2.HTTPCookieProcessor(cookieHandler) )
            urllib2.install_opener (opener)

    def do_HTTP_request (self, url, params={}, httpheaders={}):
        '''
...
Usage:
------
  python2.7 %s HASH <algorithm> OPTIONS
...
------------------------
  ...
  NOTE: for LM / NTLM it is recommended to introduce both values with this format:
		 python2.7 %s HASH LM   -h 9a5760252b7455deaad3b435b51404ee:0d7f1f2bdeac6e574d6e18ca85fb58a7
		 python2.7 %s HASH NTLM -h 9a5760252b7455deaad3b435b51404ee:0d7f1f2bdeac6e574d6e18ca85fb58a7
...
---------
  -> Try to crack only one hash.
	 python2.7 %s HASH MD5 -h 098f6bcd4621d373cade4e832627b4f6
  -> Try to crack a JUNIPER encrypted password escaping special characters.
	 python2.7 %s HASH JUNIPER -h "\$9\$LbHX-wg4Z"
  -> If the hash cannot be cracked, it will be searched in Google.
	 python2.7 %s HASH LDAP_SHA1 -h "{SHA}cRDtpNCeBiql5KOQsKVyrA0sAiA=" -g
  -> Try to crack multiple hashes using a file (one hash per line).
	 python2.7 %s HASH MYSQL -f mysqlhashesfile.txt

""" % ( (sys.argv[0],) * 8 )

    def crackHash (self, algorithm, hashvalue=None, hashfile=None):
        ...
        for activehash in hashestocrack:
            ...
            if algorithm not in [GLOBAL_VARS.JUNIPER, GLOBAL_VARS.LDAP_MD5, GLOBAL_VARS.LDAP_SHA1]:
            ...
            begin = randint(0, len(self.CRAKERS) -1)

            for i in range(len(self.CRAKERS)):
                # Select the cracker
                cr = self.CRAKERS[ ( i +begin ) %len(self.CRAKERS) ]()
                ...
                if result:
                    ...
                    if algorithm in [GLOBAL_VARS.MD4, GLOBAL_VARS.MD5, GLOBAL_VARS.SHA1,
                                     GLOBAL_VARS.SHA224, GLOBAL_VARS.SHA384, GLOBAL_VARS.SHA256,
                                     GLOBAL_VARS.SHA512, GLOBAL_VARS.RIPEMD]:
                    ...
                    elif algorithm in [GLOBAL_VARS.LDAP_MD5, GLOBAL_VARS.LDAP_SHA1]:
                    ...
                    elif algorithm == GLOBAL_VARS.NTLM or (algorithm == GLOBAL_VARS.LM and ':' in activehash):
    ...
    def searchHash(self, hashvalue):
        ...
        while not finished:
            ...
            # Send the request
            response = self.do_HTTP_request(url, httpheaders=headers)
    ...
    def main(self, argv):
        ...
        if len(argv) < 3:
            ...
            #For exemple :
            #    opts, args = getopt.getopt(['-h','-f','10','ip'],"gh:f:")
            #will return
            #    opts = [('-h',''),('-f','10')]
            #    args = ['ip']
                cmd_opts = "gh:f:"
